# Webpack plugin for CSS Tools
A [Webpack] plugin inspired to [CSS Modules] and [Tailwind] CSS framework.
...
## install
```bash
npm i -D @pastweb/webpack-css-tools
```
...
import { cssTools } from '@pastweb/webpack-css-tools';
