...
export function resolveOptions(options: CssToolsOptions, modulesMap: ModulesMap, mode: string, generateScopedName?: (name: string, filePath: string, css: string) => string): ResolvedCssUtilityOptions {
